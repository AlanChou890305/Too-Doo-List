...
**Supabase Project ID:** `qerosiozltqrbehctxdn`
...
```
com.cty0305.too.doo.list.staging,com.cty0305.too.doo.list.dev,com.cty0305.too.doo.list
```

**說明:** 測試站支援的 Bundle IDs

- `com.cty0305.too.doo.list.staging` (Staging 版本)
- `com.cty0305.too.doo.list.dev` (Development 版本)
- `com.cty0305.too.doo.list` (Production bundle ID，用於在 staging 環境測試)
...
2. 選擇 **to-do-staging** 專案 (`qerosiozltqrbehctxdn`)
...
- [ ] App ID `com.cty0305.too.doo.list.staging` 已啟用 Sign in with Apple
- [ ] App ID `com.cty0305.too.doo.list.dev` 已啟用 Sign in with Apple

### Xcode 專案

- [ ] Production Target 已添加 Sign in with Apple capability
- [ ] Staging Target 已添加 Sign in with Apple capability

### Supabase Dashboard

- [ ] Staging 專案的 Apple Provider 已啟用
- [ ] Staging 專案的 Client IDs 已正確設定
...
```bash
npx expo prebuild
npx expo run:ios --device --configuration Staging
```
