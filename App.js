...
if (Platform.OS === "web" && typeof window !== "undefined") {
  ...
  if (isOAuthCallback) {
    console.warn("🚨 [IMMEDIATE] OAuth callback detected, redirecting to native app...");
    ...
    if (redirectUrl) {
      ...
      setTimeout(() => {
        document.body.innerHTML = '<div style="font-family: -apple-system, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; flex-direction: column;"><div style="font-size: 20px; margin-bottom: 20px;">Login successful!</div><div style="font-size: 16px; color: #666;">Please return to the To Do app.</div></div>';
      }, 100);
    }
  }
}
